...
theme.set_highlights = function(opts)
    local c = require('casey.colors').get_colors()
    ...
    hl(0, 'Number', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'Boolean', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'Float', { fg = c.vscPink, bg = 'NONE' })
    ...
    hl(0, '@comment', { fg = c.vscGray, bg = 'NONE', italic = opts.italic_comments })
    hl(0, '@constant', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'GitSignsAdd', { fg = c.vscDiffGreenLight, bg = 'NONE' })
